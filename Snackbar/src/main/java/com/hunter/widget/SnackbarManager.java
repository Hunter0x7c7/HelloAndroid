...
public class SnackbarManager {
    ...
    public void show(int duration, Callback callback) {
        synchronized (mLock) {
            ...
            if (mCurrentSnackbar != null && cancelSnackbarLocked(mCurrentSnackbar,
                    ZHSnackbar.Callback.DISMISS_EVENT_CONSECUTIVE)) {
    ...
    private void scheduleTimeoutLocked(SnackbarRecord r) {
        if (r.duration == ZHSnackbar.LENGTH_INDEFINITE) {
        ...
        } else if (r.duration == ZHSnackbar.LENGTH_SHORT) {
    ...
    void handleTimeout(SnackbarRecord record) {
        synchronized (mLock) {
            if (mCurrentSnackbar == record || mNextSnackbar == record) {
                cancelSnackbarLocked(record, ZHSnackbar.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
