...
public class ZHSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private ZHSwipeRefreshLayout.OnChildScrollUpCallback mChildScrollUpCallback;
     ...
     * @param context
     */
    public ZHSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public ZHSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * gesture.
     */
    public void setOnRefreshListener(ZHSwipeRefreshLayout.OnRefreshListener listener) {
        mListener = listener;
    }
    ...
    /**
     * Set a callback to override {@link ZHSwipeRefreshLayout#canChildScrollUp()} method. Non-null
     * callback will return the value provided by the callback and ignore all internal logic.
     *
     * @param callback Callback that should be called when canChildScrollUp() is called.
     */
    public void setOnChildScrollUpCallback(@Nullable ZHSwipeRefreshLayout.OnChildScrollUpCallback callback) {
    ...
    /**
     * Classes that wish to override {@link ZHSwipeRefreshLayout#canChildScrollUp()} method
