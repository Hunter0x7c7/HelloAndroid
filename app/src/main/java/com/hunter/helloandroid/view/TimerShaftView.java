...
public class TimerShaftView extends View {
    ...
    private void init() {
        ...
        mShaftPaint.setColor(mBaseColor);
        //标尺画笔
    ...
    private void drawCurrentTime(Canvas canvas) {
        ...
        mShaftPaint.setColor(Color.argb(0xaa, 0, 0, 0));
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        canvas.drawCircle(w / 2, h * 4 / 6, mDis, mIndicatorPaint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP && !b) {
            ...
            if (mOnTimeChangeListener != null) {
                mOnTimeChangeListener.onTimeChange(this, mCurrentTime);
            }
        }
        return true;
    }
    ...
    Runnable inertiaRunnable = new Runnable() {
        ...
        public void run() {
            if (mScroller.isFinished()) {
                //时间回调
                if (mOnTimeChangeListener != null) {
                    mOnTimeChangeListener.onTimeChange(TimerShaftView.this, mCurrentTime);
                }
                return;
            }
    ...
    public interface OnTimeChangeListener {
        void onTimeChange(TimerShaftView view, String time);
    }
}
