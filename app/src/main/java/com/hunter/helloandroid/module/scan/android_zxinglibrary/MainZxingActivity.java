...
import com.hunter.helloandroid.module.scan.android_zxinglibrary.utils.CheckPermissionUtils;
...
public class MainZxingActivity extends BaseZxingActivity
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(MainZxingActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                }
            }
        }
                ...
                try {
                    CodeUtils.analyzeBitmap(ImageUtil.getImageAbsolutePath(this, uri), new CodeUtils.AnalyzeCallback() {
                        ...
                        public void onAnalyzeSuccess(Bitmap mBitmap, String result) {
                            Toast.makeText(MainZxingActivity.this, "解析结果:" + result, Toast.LENGTH_LONG).show();
                        }
    ...
    class ButtonOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.button2) {
                ...
                Intent intent = new Intent(MainZxingActivity.this, ThreeActivity.class);
    ...
    private void onClick(int buttonId) {
        switch (buttonId) {
            case R.id.button1:
                ...
                break;
            case R.id.button3:
                intent = new Intent(MainZxingActivity.this, SecondActivity.class);
                startActivityForResult(intent, REQUEST_CODE);
                break;
            default:
                break;
